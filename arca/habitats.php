...
<body>
  ...
  <main>
            ...
            <!-- ========== Start FORM ========== -->
            <form action="insert/registro_habitats.php" method="post">
            <div class="mb-3">
                <label for="input_habitat class="form-label>Nombre habitat</label>
                <input name="nombre_habitat" type="text" class="form-control" id="input_habitat">
            </div>
        ...
        <table class="table table-dark table-striped-columns">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Nombre habitat</th>
            ...
            <tbody>
                ...
                include('connection/connection_arca.php');
                            /*SELECT count(id_animal) AS cuenta, habitat.nombre_habitat AS habitat, id_habitat
                            FROM animal RIGHT JOIN habitat
                            ON animal.id_alimentacion_id = habitat.id_habitat
                            GROUP BY id_habitat */
                $consulta = "CALL p_verHabitats()";
                ...
                while ($fila = mysqli_fetch_array($resultado)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="delete/eliminar_habitats.php?id_habitat=<?php echo $fila['id_habitat'] ?>">
