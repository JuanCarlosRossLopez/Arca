    ...
    <main>
        ...
        <?php
            ...
            include('../connection/connection_arca.php');
                        //SELECT * FROM clasificacion WHERE id_clasificacion = '$id_clasificacion'
            $consulta = "CALL p_verClasificacion('$id_clasificacion')";
        ...
        <form action="actualizar_clasificacion.php" method="post">
            <div class="mb-3">
                ...
                <input name="nombre_clasificacion" value="<?php echo $fila['nombre_clasificacion']?>" type="text" class="form-control">
            </div>
